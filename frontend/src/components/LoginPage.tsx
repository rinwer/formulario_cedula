...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-md p-5 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <button
            type="submit"
            disabled={ingresando}
            className="w-full bg-cobre-600 hover:bg-cobre-700 disabled:bg-cobre-300 text-white font-medium py-2 rounded-md transition-colors"
          >
